...
import { Tag, Percent, Building2, Plus, Search, Edit, Trash2, Calendar, Users } from "lucide-react";
...
const mockDiscounts = [
  { id: "1", name: "BLACK50", type: "percentage", value: 50, usageLimit: 100, used: 67, expiresAt: "31/01/2024", status: "active" },
  { id: "2", name: "WELCOME20", type: "percentage", value: 20, usageLimit: null, used: 234, expiresAt: null, status: "active" },
  { id: "3", name: "UPGRADE100", type: "fixed", value: 100, usageLimit: 50, used: 50, expiresAt: "15/01/2024", status: "expired" },
];
      ...
      <DialogContent className="max-w-5xl max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <Tabs defaultValue="coupons" className="flex-1 flex flex-col overflow-hidden">
              ...
              <Card className="mb-4 border-primary">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-4 gap-4">
                    <div>
                      <Label>Código</Label>
                      <Input placeholder="CODIGO20" className="mt-1 uppercase" />
                    </div>
                    <div>
                      <Label>Tipo</Label>
                      <Select>
                    ...
                    <div>
                      ...
                      <Input type="number" placeholder="100 (vazio = ilimitado)" className="mt-1" />
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end gap-2 mt-4">
                    <Button variant="outline" onClick={() => setShowNewCoupon(false)}>Cancelar</Button>
                    <Button onClick={() => setShowNewCoupon(false)}>Criar Cupom</Button>
                  </div>
                </CardContent>
              </Card>
            )}
          ...
          <TabsContent value="custom" className="flex-1 overflow-hidden mt-4">
            <div className="flex justify-end mb-4">
              <Button onClick={() => setShowNewPricing(true)}>
            ...
            {showNewPricing && (
              <Card className="mb-4 border-primary">
                <CardHeader className="pb-2">
                  <CardTitle className="text-base">Novo Preço Customizado</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid md:grid-cols-4 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <Input type="number" placeholder="799" className="mt-1" />
                    </div>
                    <div>
                      <Label>Validade</Label>
                      <Input type="date" className="mt-1" />
                  ...
                  <div className="mt-4">
                    <Label>Motivo</Label>
                    <Input placeholder="Ex: Acordo corporativo, volume, etc." className="mt-1" />
                  </div>
                  <div className="flex justify-end gap-2 mt-4">
                    <Button variant="outline" onClick={() => setShowNewPricing(false)}>Cancelar</Button>
                    <Button onClick={() => setShowNewPricing(false)}>Salvar</Button>
                  </div>
                </CardContent>
              </Card>
            )}
